    ...
    <>
      ...
      >
        ...
        <ButtonGroup gap="2" marginRight="5">
          {auth ? (
            <>
              <Link to={"/ratedmovies"}>
                <Text fontSize="xl">Rated movies</Text>
              </Link>
              <Link to={"/watchedmovies"}>
                <Text fontSize="xl">Watched movies</Text>
              </Link>
              <Button onClick={logout} bg={"#FFFAFA"}>
                logout
              </Button>
            ...
            <>
              <Link to="/signup">
                {" "}
                <Button bg={"#FFFAFA"}>Sign Up</Button>{" "}
              </Link>
              <Link to="/login">
                {" "}
                <Button bg={"#FFFAFA"}>Log in</Button>
              </Link>
              <Box marginTop="2">
      ...
      <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            {watchlistmovies &&
              watchlistmovies.map((elem: watchlist, index: string) => {
                return (
                  <Box
                    maxW="15rem"
                    bg="white"
